...
@click.option("--username", default=None,
              help="Garmin Connect username. If not provided, it will be read from the GARMIN_USERNAME environment variable.")
...
def main(username: Optional[str], password: Optional[str], port: int, host: str, sse: bool):
    username = username or os.getenv("GARMIN_USERNAME")
